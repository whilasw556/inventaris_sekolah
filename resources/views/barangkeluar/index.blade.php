                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Data Barang keluar
                            <a href="{{ route('barangkeluar.create')}}" class="btn btn-primary float-right">Tambah Barang keluar</a>
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <form action="{{route('barangkeluar.destroy' ,$data->id)}}" method="post">
                                            ...
                                            <a href="{{route('barangkeluar.edit', $data->id)}}" class="btn btn-success float-right">Ubah</a>
                                            <a href="{{route('barangkeluar.show', $data->id)}}" class="btn btn-warning float-right">Tampilkan</a>
